...
=======
      ...
      <div class="elements-container">
        ...
        <div class="info-home-container">
          ...
          <DefaultBtn style="margin-top: 20px;" to="/login" text="Fazer Login" padding="2px" border_radius="60px" :font_size="widthScreen < 600 ?'35px' : '17px'" :border="widthScreen < 600 ? '3px solid black' : '2px solid black'" :height="widthScreen < 600 ? '110px' : '55px'" font_weight="600" :width="widthScreen < 600 ? '300px' : '220px'" color="white" />
>>>>>>> 8432b6b (FEAT: linked homePage with LoginPage #57)
