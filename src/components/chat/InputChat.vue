...
<template>
    <div class="container-form">
        ...
        <form @submit.prevent="">
            <input class="input-prompt" type="text" placeholder="Envie uma mensagem para βias" v-model="message">
        </form>
        <button type="submit" class="submit-button" @click="genericAIStore.postMessage(post)">
